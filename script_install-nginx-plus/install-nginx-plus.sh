...
sudo apt install -y nginx-plus=24-3~focal

sudo apt-mark hold nginx-plus

sudo apt install -y app-protect=24+3.583.0-1~focal \
nginx-plus-module-appprotect=24+3.583.0-1~focal \
app-protect-plugin=3.583.0-1~focal \
app-protect-engine=7.7.7-1~focal \
app-protect-compiler=7.7.7-1~focal

sudo apt-mark hold app-protect nginx-plus-module-appprotect app-protect-plugin app-protect-engine app-protect-compiler

sudo apt install -y nginx-plus-module-njs=24+0.7.0-1~focal
